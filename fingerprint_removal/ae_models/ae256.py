...
def transferWeighetsDecoder(ae2):
    ae.trans1.weight.data = ae2.trans1.weight.data
    ae.trans2.weight.data = ae2.trans2.weight.data
    ae.trans3.weight.data = ae2.trans3.weight.data
    ae.trans4.weight.data = ae2.trans4.weight.data
